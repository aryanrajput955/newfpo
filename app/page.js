...
export default function LandingPage() {
  ...
  return (
    <div className="font-sans text-[#1a1a2e] bg-white overflow-x-hidden">
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="bg-[#1b3a5c] px-5 py-4 flex flex-col gap-3 sticky top-[56px] z-40 lg:hidden border-t border-white/10">
          ...
          <a href="/login" className="text-white text-[15px] font-semibold py-2.5">
            Login
          </a>
        </div>
      )}
